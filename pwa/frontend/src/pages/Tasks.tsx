              ...
              return (
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: 13.5, fontWeight: 600, color: HNH.ink, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{t.title}</div>
                    <div className="flex items-center gap-2 flex-wrap" style={{ marginTop: 4 }}>
                      ...
                      {t.due_date && <span style={{ fontSize: 10.5, color: HNH.ink3 }}>{t.due_date.slice(5).replace('-', '/')}</span>}
                      {t.is_overdue && <span style={{ fontSize: 10.5, fontWeight: 700, color: HNH.red }}>Trễ {t.overdue_days}d</span>}
                    </div>
                  </div>
                  <Icon name="arrow-r" size={14} color={HNH.ink3} stroke={1.5} />
                </button>
              )
            })}
          </div>
