    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("target_department", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="base.department", related_name="notification_announcements")),
                ("target_company", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="base.company", related_name="notification_announcements")),
            ],
